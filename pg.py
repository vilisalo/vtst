import numpy as np
from operations import Inversion, Rotation, ImproperRotation, Reflection, rotation_matrix
import tools
from input_reader import hessian_reader
...
class PointGroup:
    ...
    def __init__(self,
        ...
        self._cent_coord = np.array(positions) - tools.get_center_mass(self._positions, self._masses)
        self._ref_orientation = np.identity(3)

        # determine inertia tensor
        inertia_tensor = tools.get_inertia_tensor(self._positions, self._masses)
